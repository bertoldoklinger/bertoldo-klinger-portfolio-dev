...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 98 98196-8622",
      link: "https://wa.me/5598981968622?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "bertoldokbrj@gmail.com",
      link: "mailto:bertoldokbrj@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "São Luís - MA",
      description: "Miritiua, Condominio Gran Village Boulevard 1",
      link: "https://goo.gl/maps/WsZw88qvGU4BUC936",
          ...
          <div className="basis-2/3">
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div >
                <button
                  type="submit"
                  className="button flex  bg-white items-center gap-2 text-blue-700 font-semibold px-4 py-2 rounded-lg"
                  disabled={loading}

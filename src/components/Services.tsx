...
export default function Services() {
  const services = [
    ...
    {
      title: "Sistemas",
      description: "Desenvolvimento de sistemas e APIs REST com Node.js/Nestjs, Docker, PostgreSQL, MongoDb, Prisma.",
      icon: <HiCommandLine className="h-12 w-12" />,
    },
    {
      title: "Mobile",
      description: "Desenvolvimento de aplicativos React Native/Expo Android e iOS utilizando NativeBase.",
